...
function SimulatorApp() {
  ...
  useEffect(() => {
    if (isLoadingNetwork || hasAutoGenerated || generateNetworkMutation.isPending) return;
  ...
  }, [isLoadingNetwork, networkData, hasAutoGenerated, generateNetworkMutation, expectedNodeCount]);
